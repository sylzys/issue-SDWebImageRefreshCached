...
Motion::Project::App.setup do |app|
  ...
  app.name = 'issue-SDWebImageRefreshCached'
  app.identifier = 'com.your_domain_here.issue-SDWebImageRefreshCached'
...
app.development do
  ...
  app.provisioning_profile = "signing/testplop.mobileprovision"
end
